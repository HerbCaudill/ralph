...
- `packages/ralph-ui/e2e/event-stream.spec.ts`
...
- `packages/ralph-ui/e2e/chat.spec.ts`
...
- `packages/ralph-ui/e2e/url-routing.spec.ts`
  - Task dialog routing
  - Session routing
...
- `packages/ralph-ui/e2e/navigation.spec.ts`
