...
| **systemPrompt**          | Loads and assembles the system prompt from `core.prompt.md` and `.ralph/workflow.prompt.md`. Also provides task-chat skill config (`loadTaskChatSkill`, `getTaskChatAllowedTools`, `getTaskChatModel`). |
