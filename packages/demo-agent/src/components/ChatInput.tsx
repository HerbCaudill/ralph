  ...
  return (
    <div className="flex items-end gap-2 border-t border-border bg-background px-4 py-3">
      <textarea
        ...
        rows={1}
        className="max-h-[200px] min-h-[40px] flex-1 resize-none rounded-lg border border-border bg-muted px-3 py-2 font-sans text-sm leading-relaxed text-foreground outline-none placeholder:text-muted-foreground focus:border-primary/40 disabled:opacity-50"
      />
      <button
        onClick={handleSend}
        disabled={!canSend}
