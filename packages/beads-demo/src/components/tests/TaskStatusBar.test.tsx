...
describe("TaskStatusBar", () => {
  describe("connection status", () => {
    it("shows 'Connected' when not loading and no error", () => {
      render(
        <TaskStatusBar workspace={makeWorkspace()} tasks={[]} isLoading={false} error={null} />,
      )
      expect(screen.getByText("Connected")).toBeInTheDocument()
    })

    it("shows 'Loading...' when loading", () => {
      render(<TaskStatusBar workspace={makeWorkspace()} tasks={[]} isLoading={true} error={null} />)
    ...
    it("shows spinner when loading", () => {
      const { container } = render(
        <TaskStatusBar workspace={makeWorkspace()} tasks={[]} isLoading={true} error={null} />,
      )
  ...
  describe("workspace path", () => {
    ...
    it("does not display path when workspace is null", () => {
      render(<TaskStatusBar workspace={null} tasks={[]} isLoading={false} error={null} />)
  ...
  describe("task counts", () => {
    it("shows open, closed, and total counts", () => {
      ...
      render(
        <TaskStatusBar workspace={makeWorkspace()} tasks={tasks} isLoading={false} error={null} />,
      )
