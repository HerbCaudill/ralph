...
describe("EnhancedTextInput", () => {
  describe("rendering", () => {
    it("renders with initial value", () => {
      const { lastFrame } = render(<EnhancedTextInput value="hello" onChange={vi.fn()} />)
  ...
  describe("basic input", () => {
    it("calls onChange when typing", () => {
      ...
      const { stdin } = render(<ControlledInput initialValue="" onValueChange={onValueChange} />)
      stdin.write("a")
    ...
    it("calls onSubmit when Enter is pressed", () => {
      ...
      const { stdin } = render(<ControlledInput initialValue="test" onSubmit={onSubmit} />)
      stdin.write("\r")
    ...
    it("handles backspace at end of text", () => {
      const onValueChange = vi.fn()
      const { stdin } = render(<ControlledInput initialValue="abc" onValueChange={onValueChange} />)
