...
export function CodeBlock({
  ...
  /** Whether to use dark theme (defaults to agent-view context) */
  isDark,
  ...
  const { isDark: contextIsDark } = useAgentViewContext()

  // Use provided isDark prop or fall back to context
  const effectiveIsDark = isDark ?? contextIsDark
