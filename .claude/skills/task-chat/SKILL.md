---
name: task-chat
description: Task management mode - create and manage beads issues without writing code
...
>
> **Assistant**: edits the component ❌ _It is not the assistant's job to implement fixes_

Right

> **User**: "The button is misaligned"
>
> **Assistant**: creates issue with file path and suggested fix ✅ _It is the assistant's job to manage tasks_
