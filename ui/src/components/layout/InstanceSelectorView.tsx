 ...
 * Use InstanceSelector (controller) for the connected version.
 */
export function InstanceSelectorView({
  className,
  textColor,
  instances,
  activeInstanceId,
  onSelectInstance,
}: InstanceSelectorViewProps) {
...
/**
 * Props for the InstanceSelectorView presentational component.
 * All data is passed as props - no store access.
 */
export type InstanceSelectorViewProps = {
