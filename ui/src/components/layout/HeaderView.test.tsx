...
describe("HeaderView", () => {
  ...
  describe("rendering", () => {
    it("renders logo", () => {
      render(<HeaderView accentColor="#007ACC" instanceCount={1} />)
    ...
    it("applies custom className", () => {
      const { container } = render(
        <HeaderView accentColor="#007ACC" instanceCount={1} className="custom-class" />,
      )
  ...
  describe("accent color background", () => {
    ...
    it("applies different colors correctly", () => {
      const { rerender } = render(<HeaderView accentColor="#FF5733" instanceCount={1} />)
      expect(screen.getByTestId("header")).toHaveStyle({ backgroundColor: "#FF5733" })

      rerender(<HeaderView accentColor="#9B59B6" instanceCount={1} />)
  ...
  describe("instance count badge", () => {
    ...
    it("shows badge when instanceCount is greater than 1", () => {
      render(<HeaderView accentColor="#007ACC" instanceCount={2} />)
    ...
    it("shows correct count for multiple instances", () => {
      render(<HeaderView accentColor="#007ACC" instanceCount={5} />)
      const badge = screen.getByTestId("instance-count-badge")
      expect(badge).toBeInTheDocument()
