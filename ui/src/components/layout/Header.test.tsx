...
describe("Header", () => {
  ...
  describe("instance status", () => {
    it("does not show status when Ralph is stopped", async () => {
      render(<Header />)
    ...
    it("shows status when Ralph is running", async () => {
      act(() => {
    ...
    it("shows current task title when running with task", async () => {
      act(() => {
        const store = useAppStore.getState()
        const instances = new Map(store.instances)
