...
export const MultipleToolCalls: Story = {
  args: {
    events: [
      userMessageEvent("Search for authentication files and read the main one", 50000),
      assistantTextEvent("I'll search for authentication-related files.", 48000),
      {
        type: "assistant",
        timestamp: baseTimestamp - 46000,
        message: {
          content: [
            {
              type: "tool_use",
      ...
      assistantTextEvent("I found several authentication files. Let me read the main one.", 40000),
    ],
  },
}
